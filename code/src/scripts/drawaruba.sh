...
set origin 0.350,0.0
plot [0:4] [0.5:4.5] \
'./draw.txt' using ($0/1440):(($1==2)*(4.9+$10/5)-1) with dots lc 3 title "Visising living room",\
...
plot [0:7] [-0.1:1.1] \
'./draw.txt' using ($0/1440):($10/4+0.7) with lines lc 3 title "Living room presence",\
...
plot [0:7] [-0.1:1.1] \
'./draw.txt' using ($0/1440):11 with lines lc 3 title "Living room probability",\
...
plot [0:7] [-0.1:1.1] \
'./draw.txt' using ($0/1440):12 with lines lc 3 title "Living room entropy",\
